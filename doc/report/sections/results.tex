...
\autoref{fig:visit-clock} shows average session counts aggregated into half-hour bins, separately for weekdays (Tuesday–Friday) and Saturdays (Monday/Sunday closed).
