...
We develop a session-based analytical framework (\Cref{sec:methods}) that aggregates item-level records from a large-scale dataset into user visits, recognizing that patrons borrow multiple items during a single library visit.
