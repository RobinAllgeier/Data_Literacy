...
and we measure how often later sessions match it. For any $k_0$, we compute a curve over the session index $k$ showing how often the $k$-th session matches the early preferred type.
